...
export default function CategoriesPage() {
  ...
  const { data: itemTypeConfig, isLoading: itemTypeLoading } =
    useQuery<ItemTypeConfig | null>({
                            ...
                            {itemTypeLoading ? (
                              ...
                              <div className="flex justify-between items-center bg-white border rounded p-3">
                                <div className="text-sm">
                                  <p>
                                    <b>Item Types:</b>{" "}
                                    {itemTypeConfig.itemType.join(", ")}
                                  </p>
                                  <p>
                                    <b>Brands:</b>{" "}
                                    {itemTypeConfig.brand.join(", ")}
                                  </p>
                                  <p>
                                    <b>Conditions:</b>{" "}
                                    {itemTypeConfig.condition.join(", ")}
                                  </p>
                                  <p>
                                    <b>Colors:</b>{" "}
                                    {itemTypeConfig.color.join(", ")}
                                  </p>
                                </div>
